import ZNPList_ZPP_InteractionGroup from './ZNPList_ZPP_InteractionGroup.js';
import InteractionGroupList from '../../nape/dynamics/InteractionGroupList.js';
export default class ZPP_InteractionGroupList {
	constructor() {
		this.user_length = 0;
