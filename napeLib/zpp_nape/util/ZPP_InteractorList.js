import ZNPList_ZPP_Interactor from './ZNPList_ZPP_Interactor.js';
import InteractorList from '../../nape/phys/InteractorList.js';
export default class ZPP_InteractorList {
	constructor() {
		this.user_length = 0;
