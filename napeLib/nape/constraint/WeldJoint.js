...
import ZPP_WeldJoint from '../../zpp_nape/constraint/ZPP_WeldJoint.js';
import Vec3 from '../geom/Vec3.js';
import MatMN from '../geom/MatMN.js';
import Constraint from './Constraint.js';
export default class WeldJoint extends Constraint {
	constructor(body1,body2,anchor1,anchor2,phase) {
		Constraint._hx_skip_constructor = true;
		super();
		Constraint._hx_skip_constructor = false;
		this._hx_constructor(body1,body2,anchor1,anchor2,phase);
	}
	_hx_constructor(body1,body2,anchor1,anchor2,phase) {
		if(phase == null) {
			phase = 0.0;
		}
	...
	impulse() {
		...
		let x2 = this.zpp_inner_zn.jAccz;
		if(1 >= ret.zpp_inner.m || 0 >= ret.zpp_inner.n) {
			throw haxe_Exception.thrown("Error: MatMN indices out of range");
		}
