...
import ZPP_DistanceJoint from '../../zpp_nape/constraint/ZPP_DistanceJoint.js';
import Vec3 from '../geom/Vec3.js';
import MatMN from '../geom/MatMN.js';
import Constraint from './Constraint.js';
export default class DistanceJoint extends Constraint {
	constructor(body1,body2,anchor1,anchor2,jointMin,jointMax) {
		...
		this._hx_constructor(body1,body2,anchor1,anchor2,jointMin,jointMax);
	}
	_hx_constructor(body1,body2,anchor1,anchor2,jointMin,jointMax) {
	...
	isSlack() {
		if((this.zpp_inner_zn.b1 == null ? null : this.zpp_inner_zn.b1.outer) == null || (this.zpp_inner_zn.b2 == null ? null : this.zpp_inner_zn.b2.outer) == null) {
			throw haxe_Exception.thrown("Error: Cannot compute slack for DistanceJoint if either body is null.");
		}
