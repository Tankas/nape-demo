...
import ZPP_LineJoint from '../../zpp_nape/constraint/ZPP_LineJoint.js';
import Vec3 from '../geom/Vec3.js';
import MatMN from '../geom/MatMN.js';
import Constraint from './Constraint.js';
export default class LineJoint extends Constraint {
	constructor(body1,body2,anchor1,anchor2,direction,jointMin,jointMax) {
		...
		this._hx_constructor(body1,body2,anchor1,anchor2,direction,jointMin,jointMax);
	}
	_hx_constructor(body1,body2,anchor1,anchor2,direction,jointMin,jointMax) {
		...
		let _this12 = this.zpp_inner_zn.wrap_n;
		...
		let _this14 = direction.zpp_inner;
		if(_this14._validate != null) {
			_this14._validate();
		}
		let x2 = direction.zpp_inner.x;
		if(direction != null && direction.zpp_disp) {
			throw haxe_Exception.thrown("Error: " + "Vec2" + " has been disposed and cannot be used!");
		}
		let _this15 = direction.zpp_inner;
		if(_this15._validate != null) {
			_this15._validate();
		}
		let y2 = direction.zpp_inner.y;
		if(_this12 != null && _this12.zpp_disp) {
			throw haxe_Exception.thrown("Error: " + "Vec2" + " has been disposed and cannot be used!");
		}
	...
	set_direction(direction) {
		...
		let _this = this.zpp_inner_zn.wrap_n;
		if(_this != null && _this.zpp_disp) {
			throw haxe_Exception.thrown("Error: " + "Vec2" + " has been disposed and cannot be used!");
		}
		if(direction != null && direction.zpp_disp) {
